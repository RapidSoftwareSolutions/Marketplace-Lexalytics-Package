...
$app->post('/api/Lexalytics/updateConfigurations', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','id']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','id'=>'id'];
