...
$app->post('/api/Lexalytics/createCollectionOfDocuments', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','id','tag','documents']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','id'=>'id','tag'=>'tag','documents'=>'documents'];
    $optionalParams = ['configId'=>'config_id'];
    $bodyParams = [
       'json' => ['documents','tag','id'],
       'query' => ['config_id']
    ];
