...
$app->post('/api/Lexalytics/cloneConfigurations', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','template','name']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','template'=>'template','name'=>'name'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['name','template']
    ];
