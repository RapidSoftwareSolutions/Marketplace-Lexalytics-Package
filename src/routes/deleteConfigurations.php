...
$app->post('/api/Lexalytics/deleteConfigurations', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','deleteIds']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','deleteIds'=>'deleteIds'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['deleteIds']
    ];
    ...
    if(!empty($requestParams['json']['deleteIds']))
    {
        $jsonArr = $requestParams['json']['deleteIds'];
        unset($requestParams['json']['deleteIds']);
