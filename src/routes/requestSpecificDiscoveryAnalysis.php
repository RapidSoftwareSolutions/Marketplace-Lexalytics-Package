...
$app->post('/api/Lexalytics/requestSpecificDiscoveryAnalysis', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','collectionId']);
    ...
    $query_str = "https://api.semantria.com/collection/{$data['collection_id']}.json";
