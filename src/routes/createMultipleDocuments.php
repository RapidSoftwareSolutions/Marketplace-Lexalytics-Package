...
$app->post('/api/Lexalytics/createMultipleDocuments', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','documentBody']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','documentBody'=>'documentBody'];
    ...
    $query_str = "https://api.semantria.com/document/batch.json";
