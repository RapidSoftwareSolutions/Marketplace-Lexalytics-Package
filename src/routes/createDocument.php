...
$app->post('/api/Lexalytics/createDocument', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','id','text','tag']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','id'=>'id','text'=>'text','tag'=>'tag'];
