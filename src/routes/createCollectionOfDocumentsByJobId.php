...
$app->post('/api/Lexalytics/createCollectionOfDocumentsByJobId', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','id','tag','documents','jobId']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','id'=>'id','tag'=>'tag','documents'=>'documents','jobId'=>'job_id'];
    $optionalParams = ['configId'=>'config_id'];
    $bodyParams = [
       'json' => ['documents','tag','id','job_id'],
       'query' => ['config_id']
    ];
    ...
    $query_str = "https://api.semantria.com/collection.json";
