...
$app->post('/api/Lexalytics/deleteQueries', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','queryList']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','queryList'=>'queryList'];
    ...
    if(!empty($requestParams['json']['queryList']))
    {
        $jsonArr = $requestParams['json']['queryList'];
        unset($requestParams['json']['queryList']);
