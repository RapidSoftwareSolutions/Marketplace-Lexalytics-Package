...
$app->post('/api/Lexalytics/updateQueries', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','bodyQuery']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','bodyQuery'=>'bodyQuery'];
    ...
    $query_str = "https://api.semantria.com/queries.json";
    ...
    if(!empty($requestParams['json']['bodyQuery']))
    {
        $jsonArr = $requestParams['json']['bodyQuery'];
        unset($requestParams['json']['bodyQuery']);
