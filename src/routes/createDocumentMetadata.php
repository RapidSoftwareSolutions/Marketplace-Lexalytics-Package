...
$app->post('/api/Lexalytics/createDocumentMetadata', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','apiSecret','id','tag','text','metadata']);
    ...
    $requiredParams = ['apiKey'=>'api_key','apiSecret'=>'api_secret','id'=>'id','tag'=>'tag','text'=>'text','metadata'=>'metadata'];
    $optionalParams = [];
    $bodyParams = [
       'json' => ['metadata','text','id','tag']
    ];
    ...
    $query_str = "https://api.semantria.com/document.json";
