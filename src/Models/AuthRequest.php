...
class AuthRequest
{
    ...
    function authWebRequest($method, $url, $body)
    {
        ...
        $url = 'https://api.semantria.com/document/batch.json';
        ...
        exit();
//$query = str_replace('https://api.semantria.com/subscription.json','https://api.semantria.com/status.json',$query);
...
//        //	print_r($response);
//        //print_r(json_decode($response['message']));
//        exit();
//
//        return $response;
    }
    ...
    public function generateQuery($method, $url, $timestamp, $nonce)
    {
        $ps = @parse_url($url);
    ...
    public function generateAuthHeader($query, $timestamp, $nonce)
    {
